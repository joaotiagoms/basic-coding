    ...
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Here is the story:\nOnce upon a time there was a " +
             profession + " called " + name + "\nOn her way to work, " + name + 
             " often pondered what being " + profession + " meant to them.\nWhen you work as a " + 
             profession + " you meet interesting people.\n" + name + 
             " enjoys their work as " + profession + ", The end.");
